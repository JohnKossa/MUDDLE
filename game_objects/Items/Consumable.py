...
class FocusPotion(Consumable):
    ...
    def use_effect(self, game: Game, source_player: Character, params: List[Any]) -> None:
        from game_objects.Status.FocusPotionStatus import FocusPotionStatus
        game.discord_connection.send_game_chat_sync(f"{source_player.combat_name} drinks a focus potion.")
...
class RagePotion(Consumable):
    ...
    def use_effect(self, game: Game, source_player: Character, params: List[Any]) -> None:
        from game_objects.Status.RagePotionStatus import RagePotionStatus
        game.discord_connection.send_game_chat_sync(f"{source_player.combat_name} drinks a focus potion.")
